...
$module['widget'] .= "\t\t\t" . '"hide_empty" => "true",' . "\r\n";
$module['widget'] .= "\t\t" . ');' . "\r\n";
$module['widget'] .= "\t\t" . '' . "\r\n";
$module['widget'] .= "\t\t" . '$terms = get_terms("{{OPTION}}",$args);' . "\r\n";

$module['widget'] .= "\t\t" . 'foreach($terms as $term){' . "\r\n";
$module['widget'] .= "\t\t\t" . '' . "\r\n";
$module['widget'] .= "\t\t\t" . '//use this variable for get taxonomies data;' . "\r\n";
$module['widget'] .= "\t\t\t" . '$term_id = $term->term_id;' . "\r\n";
$module['widget'] .= "\t\t\t" . '$name = $term->name;' . "\r\n";
$module['widget'] .= "\t\t\t" . '$description = $term->description;' . "\r\n";
$module['widget'] .= "\t\t\t" . '$count = $term->count;' . "\r\n";
$module['widget'] .= "\t\t\t" . '$href = get_tag_link($term_id);' . "\r\n";
$module['widget'] .= "\t\t\t" . '' . "\r\n";
$module['widget'] .= "\t\t\t" . '//use this variable for get extra-field;' . "\r\n";
...
foreach ($getExtraFields as $extraField)
{
    ...
    if (in_array($__field['option'], $extraField['taxonomies']))
    {
        foreach ($extraField['fields'] as $_field)
        {
            ...
            $module['widget'] .= "\t\t\t" . '$extra_data_' . $nameVar . ' = get_term_meta($term_id, "' . $nameId . '", true );' . "\r\n";
        }
    }
}
$module['widget'] .= "\t\t\t" . '' . "\r\n";
$module['widget'] .= "\t\t\t" . '// show to html' . "\r\n";
$module['widget'] .= "\t\t\t" . 'echo \'<a style="padding: 6px;margin-left: 6px;margin-bottom: 6px;border: 1px solid #ddd;background: #ddd;border-radius: 6px;display: inline-block;" href="\'.$href.\'">\'.$name.\' (\'.$count.\')</a>\';' . "\r\n";
$module['widget'] .= "\t\t" . '}' . "\r\n";
