...
$module['edit_form_fields'] .= "\t\t\t\t" . '<input type="date" id="{{ID}}" name="{{NAME}}" placeholder="{{PLACEHOLDER}}" value="<?php echo esc_attr($current_data); ?>"/>' . "\r\n";
...
$module['add_form_fields'] .= "\t\t\t" . '<input type="date" value="{{DEFAULT}}" size="40" id="{{ID}}" name="{{NAME}}" placeholder="{{PLACEHOLDER}}"/>' . "\r\n";
