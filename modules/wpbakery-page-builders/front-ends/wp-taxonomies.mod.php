...
$module['shortcode'] .= "\t\t\t" . '$output .= \'<a style="padding: 6px;margin-left: 6px;margin-bottom: 6px;border: 1px solid #ddd;background: #ddd;border-radius: 6px;display: inline-block;" href="\'.$href.\'">\'.$name.\' (\'.$count.\')</a>\';' . "\r\n";
$module['shortcode'] .= "\t\t" . '}' . "\r\n";
