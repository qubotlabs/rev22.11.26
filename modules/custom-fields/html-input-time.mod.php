...
$module['render_content'] .= "\t\t\t" . '<input class="regular-text {{SHORTNAME}}-form-control" type="time" id="{{ID}}" name="{{NAME}}" value="<?php echo esc_attr($current_data); ?>" placeholder="{{OPTIONS}}" />' . "\r\n";
...
$module['dummy'] = date('H:s');



$module['wp_ajax'] = null;
$module['wp_ajax'] .= "\t\t" . '' . "\r\n";
$module['wp_ajax'] .= "\t\t" . '// save time' . "\r\n";
$module['wp_ajax'] .= "\t\t" . '${{VAR}} = "";' . "\r\n";
...
$module['fontend_content'] .= "\t\t" . '$content .= \'<input class="{{SHORTNAME}}-form-control" type="time" id="{{ID}}" name="{{NAME}}" placeholder="{{OPTIONS}}" />\';' . "\r\n";
